            ...
            {projects.map((project, i) => (
              ...
              >
                <img
                  src={project?.image}
                  className={
                    "hidden md:block h-full w-full absolute top-0 bottom-0 left-0 right-0 group-hover:opacity-0 transition duration-[400ms] lg:group-hover:scale-[110%] lg:object-center	lg:object-cover"
                  }
                />
                <img
                  src={project?.mobImage}
                  className={
                    "block md:hidden h-full w-full absolute top-0 bottom-0 left-0 right-0 group-hover:opacity-0 transition duration-[400ms] lg:group-hover:scale-[110%] object-center object-cover"
                  }
                />
