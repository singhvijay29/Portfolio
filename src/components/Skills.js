...
export default function Skills() {
  return (
    <div className="gradient-to-black w-[100vw] overflow-hidden">
      <section
        id="Skills"
        class="skills-section container mx-auto py-[80px] px-6"
      >
        ...
        <div class="skills-div">
          ...
          <div class="skills-card">
            <img
              src="https://aorgish.github.io/web-sockets-internals-slides/img/ws-logo.png"
              alt="websocket"
            />
            <h3>Websocket</h3>
          </div>
          ...
          <div class="skills-card">
            <img src="https://cdn.svgporn.com/logos/dart.svg" alt="dart" />
            <h3>Dart</h3>
          </div>
          <div class="skills-card">
            <img
